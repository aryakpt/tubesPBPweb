        ...
        <div id="content">
            ...
            <div class="container-fluid">
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-dark">Data Penulis</h1>
                </div>
                <div class="card">
                        <div class="card-body">
                            <table class="table table-striped">
                                ...
                                <?php
                                    ...
                                    while ($row = $result->fetch_object()){
                                        ...
                                        echo '<td class="text-center"><a type="button" class="btn btn-warning btn-sm text-white" onclick="resetpw('.$row->idpenulis.');"><i class="fas fa-key"></i> Reset Password</a></td>';
                                        echo '</tr>';
                                        $i++;
                                    }
                                ?>
