                ...
                <?php
                    if(!isset($_SESSION['penulis'])){
                        ...
                        echo '              </span>
                                                ...
                                                <img class="img-profile rounded-circle" src="data:image/jpeg;base64,'.base64_encode($gambar).'" style="object-fit:cover; width:30px; height:30px;">';
                                ...
                                <?php
                                    ...
                                    <div class="tentang">
                                        ...
                                        <div class="tentang-penulis">  
                                            <img src="data:image/jpeg;base64,'.base64_encode($foto).'" class="img-profile rounded-circle" alt="gambarpenulis"
                                            <div>
                                                <h3>'.$namapenulis.'</h3>
                                                <p>'.$emailpenulis.'</p>
                                            </div>
